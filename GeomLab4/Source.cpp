...
public:
	...
	void fromHSLToRGB() {
		...
		double H = this->red / 255.0 * 360.0;
		double S = this->green / 255.0;
		double L = this->blue / 255.0;
	...
	void fromRGBToHSL() {
		...
		double r = this->red / 255;
		double g = this->green / 255;
		double b = this->blue / 255;
	...
	void fromCMYtoRGB() {
		this->red = 255.0 - this->red;
		this->green = 255.0 - this->green;
		this->blue = 255.0 - this->blue;
	}
	...
	void fromRGBtoYCbCr601() {
		float fr = this->red / 255;
		float fg = this->green / 255;
		float fb = this->blue / 255;
	...
	void fromYCbCr601toRGB(){
		float r = max(0.0f, min(1.0f, (float)(this->red / 255 + 0.0000 * this->green /255 + 1.4022 * this->blue / 255)));
		float g = max(0.0f, min(1.0f, (float)(this->red / 255 - 0.3456 * this->green /255 - 0.7145 * this->blue / 255)));
		float b = max(0.0f, min(1.0f, (float)(this->red / 255 + 1.7710 * this->green /255 + 0.0000 * this->blue / 255)));
	...
	void fromYCbCr709toRGB() {
		float r = max(0.0f, min(1.0f, (float)(this->red / 255 + 0.0000 * this->green / 255 + 1.28033 * this->blue / 255)));
		float g = max(0.0f, min(1.0f, (float)(this->red / 255 - 0.21482 * this->green / 255 -0.38059 * this->blue / 255)));
		float b = max(0.0f, min(1.0f, (float)(this->red / 255 + 2.12798 * this->green / 255 + 0.0000 * this->blue / 255)));
